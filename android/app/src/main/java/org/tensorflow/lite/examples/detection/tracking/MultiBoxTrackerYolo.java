...
import org.tensorflow.lite.examples.detection.tflite.ClassifierYolo.Recognition;

/**
 * A tracker wrapping ObjectTracker that also handles non-max suppression and matching existing
 * objects to new detections.
 */
public class MultiBoxTrackerYolo {
    ...
    public MultiBoxTrackerYolo(final Context context) {
