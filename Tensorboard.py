...
#   parser.add_argument(
#       "C:/Users/Marc/AppData/Local/Temp/tiny-yolo-obj.pb",
#       type=str,
#       default="",
#       required=True,
#       help="C:/Users/Marc/AppData/Local/Temp/tiny-yolo-obj.pb")
#   parser.add_argument(
#       "/tmp/tensorflow_logdir",
#       type=str,
#       default="",
#       required=True,
#       help="/tmp/tensorflow_logdir")
#   FLAGS, unparsed = parser.parse_known_args()
# app.run(main=main, argv=[sys.argv[0]] + unparsed)
# =============================================================================
#    import_to_tensorboard("C:/Users/Marc/AppData/Local/Temp/tiny-yolo-obj.pb", "/tmp/tensorflow_logdir")
    import_to_tensorboard("FrozenGraph/JassRNN.pb", "/tmp/tensorflow_logdir")
